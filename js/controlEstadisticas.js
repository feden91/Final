app.controller('controlEstadisticas', function($scope, $http, $location, $state, $auth) {
...
Highcharts.chart('container', {
    ...
    xAxis: {
        categories: ['Cantidad Usuarios', 'Cantidad ventas', 'Cantidad de productos', 'Cantidad de ventas que fueron Pagadas']
    },
    credits: {
        enabled: false
    },
